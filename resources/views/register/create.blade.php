                ...
                <div class="m-6">
                    <form class="mb-4" method="POST" action="/register">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" value="{{ old('name') }}" name="name" required id="name"
                        ...
                        <div class="mb-6">
                            <label for="username"
                                class="block mb-2 text-sm text-gray-600 dark:text-gray-400">USERNAME</label>
                            <input type="text" value="{{ old('username') }}" name="username" required id="username"
